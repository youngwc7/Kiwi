...
inline constexpr uint32_t ENPASSANT_MASK       = 0b00000000000000000001000000000000;
inline constexpr uint32_t PROMOTION_MASK       = 0b00000000000000001110000000000000;
inline constexpr uint32_t CASTLE_MASK          = 0b00000000000011110000000000000000;
...
inline constexpr int PROMOTION_BIT_LSB      = 13;
inline constexpr int CASTLE_BIT_LSB         = 16;
